...
const Couresel = () => {
  ...
  return (
    <div className='row-span-1 md:h-3/5'>
        <div  id="carousel" className='absolute top-0 left-0 md:flex md:h-96 lg:h-fit  xl:h-3/5'>
            ...
            <div className='m-7 md:h-full md:w-5/12 md:m-3 lg:m-4 md:p-12 lg:p-12 xl:p-20 xxl:p-24'>
                <h1 className='md:py-1 py-6 md:mb-2 lg:mb-5 xl:mb-7 xxl:mb-10 text-4xl md:text-2xl lg:text-3xl xl:text-4xl xxl:text-5xl xxl:p-4 font-bold'>{images[current].title}</h1>
                <p className='font-medium text-gray-400 text-lg md:text-xs lg:text-xs xl:text-sm xxl:text-lg'>{images[current].text}</p>
