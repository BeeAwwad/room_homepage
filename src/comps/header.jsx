    ...
    <>
      <header className="bg-gray-500 items-center p-6 my-5 font-sparta">
        <nav className='flex justify-end md:justify-start gap-12'>
          <span className='absolute left-1/2 top-11 transform -translate-x-1/2 md:static text-white'>room</span>
          <div onClick={()=>setOpen(!open)} className='z-50 md:hidden absolute left-2 top-10'>
            {open ? close : burger}
          </div>

          <ul className={`text-white items-center md:items-start bg-gray-700 w-full h-28 md:h-0 absolute p-5 md:p-0 top-0 right-0 md:static flex justify-end md:justify-normal gap-4 transition-all duration-500 ease-in ${open ? 'top-0': 'top-[-300px]'}`}>
            <li>home</li>
            <li>shop</li>
            <li>about</li>
            <li>contact</li>
