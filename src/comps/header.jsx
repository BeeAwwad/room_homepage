    ...
    <>
      <header className="w-full absolute top-0 left-0 items-center p-6 my-5 font-sparta">
        <nav className='flex justify-end md:justify-start md:gap-4 gap-12'>
          ...
          <ul className={`text-lg font-semibold text-black md:text-white items-center md:items-start bg-white w-full h-28 md:h-0 absolute p-5 md:p-0 right-0 md:static flex justify-end md:justify-normal gap-4 transition-all md:mt-2 md:text-sm lg:text-base xl:text-lg duration-400 z-40 ease-in ${open ? '-top-6': 'top-[-300px]'}`}>
            {
              Links.map((link)=>(
